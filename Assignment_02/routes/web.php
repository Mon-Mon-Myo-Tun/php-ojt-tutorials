...
Route::get('students/export/', [StudentController::class, 'Export'])->name('export#student');
Route::post('students/import/', [StudentController::class, 'Import'])->name('import#student');
