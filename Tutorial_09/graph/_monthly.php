<?php
    ...
    */
    function count_posts_on_day($conn, $day) {
        $query = "SELECT COUNT(*) as post_count FROM posts WHERE DATE(created_datetime) = '$day'";
            ...
            <div class="card-header border-bottom-0 bg-white mb-3">
                ...
                <div class="float-end">
                    <div class="btn btn-outline-secondary">
                        <a href="../graph/_weekly.php" class="text-decoration-none text-secondary">Weekly</a>
                    </div>
                    <div class="btn btn-secondary">
                        <a href="#" class="text-decoration-none text-secondary text-light">Monthly</a>
                    </div>
                    <div class="btn btn-outline-secondary">
                        <a href="../graph/_yearly.php" class="text-decoration-none ">Yearly</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
